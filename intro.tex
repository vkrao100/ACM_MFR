...
% updated specification in a cost effective way. This is achieved by reusing prior design efforts and avoiding rerunning the entire synthesis flow, while adhering to the resource constraints and the physical design limitations.  
...
% \cite{farimah:2017:1,MF_Rolf:ISVLSI18,Utkarsh:VLSI18,Vkrao:FMCAD18,Vkrao:ISQED21}.  
...
error-control codes. 
% As arithmetic bugs may lead to security
...
%5modeling and analyzing its computations in symbolic sampling domain. 
...
% Our algebraic approach provides a scalable solution into MFR checking
